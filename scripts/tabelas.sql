...
CREATE TABLE RTC_OPERACOES (
  ...
  CCLASSTRIB RTC_CCLASSTRIB_C REFERENCES RTC_CCLASSTRIB(CCLASSTRIB)-- se preenchido, override global da operação
);
...
CREATE TABLE RTC_NCM_CCLASSTRIB (
  ...
  CONSTRAINT PK_RTC_NCM_CCLASSTRIB PRIMARY KEY (NCM_NBS, REGRA_RTC, ID_PARTICIPANTE),
...
CREATE INDEX IX_NCM_NBS_CCT_LOOKUP ON RTC_NCM_CCLASSTRIB (NCM_NBS, REGRA_RTC, ID_PARTICIPANTE);

CREATE TABLE PRODUTO (
  ID_PRODUTO  INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  DESCRICAO   VARCHAR(255),
  NCM_NBS         VARCHAR(10),
  CCLASSTRIB VARCHAR(7) REFERENCES CCLASSTRIB_OFICIAL(CCLASSTRIB), -- se preenchido, usa do produto ao invés da tabela RTC_NCM_CCLASSTRIB
...
CREATE INDEX IX_RTC_OPERACOES_PRODUTO_ID  ON RTC_OPERACOES_PRODUTO (ID);
CREATE INDEX IX_RTC_OPERACOES_PRODUTO_PROD ON RTC_OPERACOES_PRODUTO (ID_PRODUTO);
